module.exports = new Object({
    ...
    async execute(client, message, args, prefix, color, dispatcher) {
        ...
        const queuedSongs = dispatcher.queue.map((track, i) => `\`${i + 1}.\` [${track.title.length > 64 ? track.title.substring(0, 64) + '...' : track.title}](${track.uri}) | (${track.isStream ? 'LIVE' : client.util.duration(track.length)}) | ${track.requester}\n`);
