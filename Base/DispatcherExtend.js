...
module.exports = class PlayerExtends extends KazagumoPlayer {
    ...
    setSpeed(amount) {
        if (!amount)
            return console.error(
                "[Function Error]: Please provide a valid number.",
            );
    ...
    setPop(value) {
        if (typeof value !== "boolean")
            return console.error("Type Must be boolean");
        this.pop = value;
        if (this.pop) {
            if (!this.filter) this.filter = value;
            this.shoukaku.setFilters({
    ...
    setNightCore(value) {
        if (typeof value !== "boolean")
            return console.error(
                "[ setNightCore Function Error ]: Please provide a valid value (true/false).",
            );
    ...
    setVaporwave(value) {
        if (typeof value !== "boolean")
            return console.error(
                "[ setVaporwave Function Error ]: Please provide a valid value (ture/false).",
            );
